...
const Plans: React.FC<PlansProps> = ({ user }) => {
  ...
  const plans = [
    { name: "Basic", profit: "40%", desc: "Perfect for beginners starting small." },
    { name: "Standard", profit: "75%", desc: "For growing investors seeking balance." },
    { name: "Premium", profit: "100%", desc: "For professionals aiming for max returns." },
  ];
  ...
  return (
    <section
      ...
      className={`py-20 px-6 md:px-16 transition-colors duration-500 ${
        theme === "dark" ? "bg-[#090015] text-white" : "bg-gray-50 text-gray-900"
      }`}
    >
      <h3
